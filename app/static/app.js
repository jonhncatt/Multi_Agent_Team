...
function normalizeCompactionStatus(raw) {
  ...
  return {
    ...
    compacted_until_item_id: String(status.compacted_until_item_id || status.compacted_until_turn_id || "").trim(),
    ...
    incomplete_protocol_transactions: Math.max(0, Number(status.incomplete_protocol_transactions || 0) || 0),
